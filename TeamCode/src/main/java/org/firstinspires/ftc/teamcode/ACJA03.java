...
// @Disabled
@Autonomous(name = "ACJA03", group = "")
public class ACJA03 extends LinearOpMode {
    /*
     * Motors:
     * CH0: intakeMotor
     * CH1: frMotor
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (barcodePosition.equals(BarcodePosition.NOT_FOUND)) {
            ...
            aCommand();
            strafeRight(200 * 1 / voltageSensor.getVoltage(), 70);
            moveForward(575 * 1 / voltageSensor.getVoltage(), 45);
            moveForward(105 * 1 / voltageSensor.getVoltage(), 27);
            spinWheelBlue(((int)(3000 * 1/ voltageSensor.getVoltage())));
            moveBackward(200 * 1 / voltageSensor.getVoltage(), 70);
            strafeRight(200 * 1 / voltageSensor.getVoltage(), 70);
            rotateRight(550 * 1 / voltageSensor.getVoltage(), 74);
            yTopCommand();
            moveForward(500 * 1 / voltageSensor.getVoltage(), 60);
            openDrop();
            sleep(850);
            closeDrop();
            moveBackward(200 * 1 / voltageSensor.getVoltage(),60);
            a1Command();
            rotateRight(300 * 1 / voltageSensor.getVoltage(),70);
            moveForward(800 * 1 / voltageSensor.getVoltage(), 60);
            strafeRight(400 * 1 / voltageSensor.getVoltage(),60);
            rotateRight(50 * 1 / voltageSensor.getVoltage(), -70);
            strafeRight(150 * 1 / voltageSensor.getVoltage(),62);
            moveForward(3000 * 1 / voltageSensor.getVoltage(), 30);
            strafeRight(200 * 1 / voltageSensor.getVoltage(),-60);
            rotateRight(1000 * 1 / voltageSensor.getVoltage(), -70);
            xCommand();
            bCommand();
            ...
            intakeFreight();
            aCommand();
            strafeRight(1000 * 1 / voltageSensor.getVoltage(), -62);
            moveForward(3000 * 1 / voltageSensor.getVoltage(), 30);
            strafeRight(1000 * 1 / voltageSensor.getVoltage(), 62);
    ...
    public void spinWheelBlue(int time) {
