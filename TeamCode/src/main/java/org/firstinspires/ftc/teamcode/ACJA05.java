...
@Autonomous(name = "ACJA05", group = "")
public class ACJA05 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (barcodePosition.equals(BarcodePosition.NOT_FOUND)) {
            ...
            bCommand();
            sleep(300);
            intakeMove(2200,25); //the time here is rlly inaccruate idk but this works
            aCommand();
            SpitOutIntakeMove(175,60);
            yTopCommand();
            strafeLeft(230, -40);
            SpitOutIntakeMove(600, 70);
            strafeLeft(230, -40);
            moveForward(450, 40);
            strafeLeft(400, 40);
            rotateRight(480, 72); // MATCH
            moveForward(600, 40);
            openDrop();
            sleep(850);
            closeDrop();
