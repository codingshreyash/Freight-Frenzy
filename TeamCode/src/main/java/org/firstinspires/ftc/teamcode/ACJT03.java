...
/* TELE-OP CLASS*/
@TeleOp(name = "ACJT03", group = "Opmode")
public class ACJT03 extends OpMode {
    ...
    //private DcMotor cMotor; // carousel motor
    ...
    public void init() {
        ...
        //cMotor  = hardwareMap.get(DcMotor.class, "cMotor");
