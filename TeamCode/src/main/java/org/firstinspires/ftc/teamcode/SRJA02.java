...
@Disabled
public class SRJA02 extends OpMode {
    ...
    private boolean rotateRight(double rotateAngle, double rotatePower) {
        ...
        telemetry.addData("currangle", Math.abs(getAngle()));
        if (Math.abs(getAngle()) < rotateAngle) {
            // flMotor.setPower(-.85);
            blMotor.setPower(.85);
            //frMotor.setPower(-.85);
...
//            autoSequence.add((Void) -> driveDistance(6, 60));
//            autoSequence.add((Void) -> rotateRight(45, 80));
            return true;
...
//            autoSequence.add((Void) -> rotateRight(45, 80));
         ...
         */
            ...
            // autoSequence.add((Void) -> driveDistance(6, 60));
         //   autoSequence.add((Void) -> rotateRight(45, 85));
           // telemetry.addData("currangle", Math.abs(getAngle()));
