...
public class SRJA05 extends LinearOpMode {
    /*
     * Motors:
     * CH0: intakeMotor
     * CH1: frMotor
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (barcodePosition.equals(BarcodePosition.NOT_FOUND)) {
            voltage = 1.0/(hardwareMap.voltageSensor.get("flMotor").getVoltage());
            telemetry.addData("not found", 1);
            telemetry.addData("flMotor Voltage", voltage);
            telemetry.update();
            // 85 percent speed : 1000ms - 70 inch
            aCommand();
            strafeRight(200, voltage * 70);
            moveForward(460, voltage * 45);
            moveForward(110, voltage * 27);
            spinWheelBlue(3000);
            moveBackward(200, voltage * 70);
            strafeRight(200, voltage * 70);
            rotateRight(550, voltage * 74);
            yCommand();
            moveForward(500, voltage * 60);
            openDrop();
            sleep(850);
            closeDrop();
            moveBackward(200,voltage * 60);
            a1Command();
            rotateRight(300,voltage * 70);
            moveForward(800, voltage * 60);
            strafeRight(400,voltage * 60);
            rotateRight(50, voltage * -70);
            strafeRight(150,voltage * 62);
            moveForward(3000, voltage * 30);
            strafeRight(200,voltage * -60);
            rotateRight(1000, voltage * -70);
            xCommand();
            bCommand();
